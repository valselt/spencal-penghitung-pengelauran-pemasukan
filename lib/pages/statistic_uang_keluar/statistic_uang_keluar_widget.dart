...
import 'statistic_uang_keluar_model.dart';
export 'statistic_uang_keluar_model.dart';

class StatisticUangKeluarWidget extends StatefulWidget {
  const StatisticUangKeluarWidget({super.key});

  @override
  State<StatisticUangKeluarWidget> createState() =>
      _StatisticUangKeluarWidgetState();
}

class _StatisticUangKeluarWidgetState extends State<StatisticUangKeluarWidget> {
  late StatisticUangKeluarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatisticUangKeluarModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PemasukanRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PemasukanRecord> statisticUangKeluarPemasukanRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final statisticUangKeluarPemasukanRecord =
            statisticUangKeluarPemasukanRecordList.isNotEmpty
                ? statisticUangKeluarPemasukanRecordList.first
                : null;
                            ...
                            child: Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: FlutterFlowLineChart(
                                  data: [
                                    FFLineChartData(
                                      xData: listViewPengeluaranRecord!.tanggal,
                                      yData: listViewPengeluaranRecord
                                          .listuangkeluar,
                                      settings: LineChartBarData(
                                        color: const Color(0xB2FF2400),
                                        barWidth: 2.0,
                                        isCurved: true,
                                        belowBarData: BarAreaData(
                                          show: true,
                                          color: const Color(0x80FB8674),
                                        ),
                                      ),
                                    )
                                  ],
